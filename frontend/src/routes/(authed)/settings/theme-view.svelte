	...
	>
		...
		>
			...
			<div class="mt-2 grid grid-cols-3 items-center gap-2">
				<Button size="sm" class="text-[9px] font-semibold" variant="secondary"
					>Stop Container</Button
				>
				<Button size="sm" class="text-[8px] font-semibold">Restart Container</Button>
				<Button size="sm" variant="destructive" class="text-[8px] font-semibold"
